...
# Hyper Parameter란 신경망 학습을 통해서 튜닝 또는 최적화 해야 하는 주변수가 아니라
# 학습 진도율이나 일반화 변수처럼,
...
# hyperparameters:
hparams = HParams(
    learning_rate=0.1, num_hidden_units=100
    )
...
def hparams_debug_string():
    ...
    # returns : A dictionary with hyperparameter names as keys. 
    # the values are the hyperparameter values.
